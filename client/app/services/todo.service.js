...
var TodosService = (function () {
    ...
    TodosService.prototype.saveTodos = function (todos) {
        var headers = new http_1.Headers();
        headers.append("content-type", "application/json");
        return this._http.post('api/v1/todo', JSON.stringify(todos), { headers: headers }).map(function (res) { return res.json(); });
    };
    return TodosService;
}());
